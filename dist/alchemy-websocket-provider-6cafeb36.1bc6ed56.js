...
})({"7O2or":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = 50619;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "710863cc1bc6ed56";
"use strict";
...
var _alchemyProvider3B044Dd5Js = require("./alchemy-provider-3b044dd5.js");
...
var process = require("b0b4f65f1c924f4b");
/**
 ...
 */ class WebsocketBackfiller {
     ...
     */ getNewHeadsBackfill(isCancelled, previousHeads, fromBlockNumber) {
        return (0, _indexE438853BJs._)(this, void 0, void 0, function*() {
            ...
            // new heads.
            const lastSeenBlockNumber = (0, _indexE438853BJs.f)(previousHeads[previousHeads.length - 1].number);
     ...
     */ getLogsBackfill(isCancelled, filter, previousLogs, fromBlockNumber) {
        return (0, _indexE438853BJs._)(this, void 0, void 0, function*() {
            ...
            // worth of logs.
            const lastSeenBlockNumber = (0, _indexE438853BJs.f)(previousLogs[previousLogs.length - 1].blockNumber);
            const minBlockNumber = toBlockNumber - this.maxBackfillBlocks + 1;
            ...
            const removedLogs = previousLogs.filter((log)=>(0, _indexE438853BJs.f)(log.blockNumber) > commonAncestor.blockNumber).map((log)=>Object.assign(Object.assign({}, log), {
                    removed: true
                }));
            // If no common ancestor was found, start backfill from the oldest log's
            // block number.
            const fromBlockInclusive = commonAncestor.blockNumber === Number.NEGATIVE_INFINITY ? (0, _indexE438853BJs.f)(previousLogs[0].blockNumber) : commonAncestor.blockNumber;
            let addedLogs = yield this.getLogsInRange(filter, fromBlockInclusive, toBlockNumber + 1);
            // De-dupe any logs that were already emitted.
            addedLogs = addedLogs.filter((log)=>log && ((0, _indexE438853BJs.f)(log.blockNumber) > commonAncestor.blockNumber || (0, _indexE438853BJs.f)(log.logIndex) > commonAncestor.logIndex));
            throwIfCancelled(isCancelled);
            return [
                ...removedLogs,
                ...addedLogs
     ...
     */ getBlockNumber() {
        return (0, _indexE438853BJs._)(this, void 0, void 0, function*() {
            ...
            return (0, _indexE438853BJs.f)(blockNumberHex);
        });
    }
    /**
     ...
     */ getReorgHeads(isCancelled, previousHeads) {
        return (0, _indexE438853BJs._)(this, void 0, void 0, function*() {
            ...
            for(let i = previousHeads.length - 1; i >= 0; i--){
                ...
                const blockHead = yield this.getBlockByNumber((0, _indexE438853BJs.f)(oldEvent.number));
                throwIfCancelled(isCancelled);
     ...
     */ getBlockByNumber(blockNumber) {
        return (0, _indexE438853BJs._)(this, void 0, void 0, function*() {
            return this.provider.send("eth_getBlockByNumber", [
                (0, _indexE438853BJs.t)(blockNumber),
                false
            ]);
        });
    }
     ...
     */ getCommonAncestor(isCancelled, previousLogs) {
        return (0, _indexE438853BJs._)(this, void 0, void 0, function*() {
            // Iterate from the most recent head backwards in order to find the first
            // block that was part of a re-org.
            let blockHead = yield this.getBlockByNumber((0, _indexE438853BJs.f)(previousLogs[previousLogs.length - 1].blockNumber));
            throwIfCancelled(isCancelled);
            for(let i = previousLogs.length - 1; i >= 0; i--){
                const oldLog = previousLogs[i];
                // Ensure that updated blocks are fetched every time the log's block number
                // changes.
                if (oldLog.blockNumber !== blockHead.number) blockHead = yield this.getBlockByNumber((0, _indexE438853BJs.f)(oldLog.blockNumber));
                // Since logs are ordered in ascending order, the first log that matches
                // the hash should be the largest logIndex.
                if (oldLog.blockHash === blockHead.hash) return {
                    blockNumber: (0, _indexE438853BJs.f)(oldLog.blockNumber),
                    logIndex: (0, _indexE438853BJs.f)(oldLog.logIndex)
                };
            }
            return {
     ...
     */ getLogsInRange(filter, fromBlockInclusive, toBlockExclusive) {
        return (0, _indexE438853BJs._)(this, void 0, void 0, function*() {
            ...
            const rangeFilter = Object.assign(Object.assign({}, filter), {
                fromBlock: (0, _indexE438853BJs.t)(fromBlockInclusive),
                toBlock: (0, _indexE438853BJs.t)(toBlockExclusive - 1)
            });
 ...
 */ class AlchemyWebSocketProvider extends (0, _providers.WebSocketProvider) {
    /** @internal */ constructor(config, wsConstructor){
        ...
        const apiKey = (0, _alchemyProvider3B044Dd5Js.AlchemyProvider).getApiKey(config.apiKey);
        // Generate our own connection info with the correct endpoint URLs.
        const alchemyNetwork = (0, _alchemyProvider3B044Dd5Js.AlchemyProvider).getAlchemyNetwork(config.network);
        const connection = (0, _alchemyProvider3B044Dd5Js.AlchemyProvider).getAlchemyConnectionInfo(alchemyNetwork, apiKey, "wss");
        const protocol = `alchemy-sdk-${(0, _indexE438853BJs.V)}`;
        ...
        const ethersNetwork = (0, _indexE438853BJs.E)[alchemyNetwork];
         ...
         */ this.handleReopen = ()=>{
            ...
            for (const subscription of this.virtualSubscriptionsById.values())(()=>(0, _indexE438853BJs._)(this, void 0, void 0, function*() {
                    try {
        ...
        this.startHeartbeat();
        this.cancelBackfill = (0, _indexE438853BJs.n);
    }
    /**
     ...
     */ static getNetwork(network) {
        if (typeof network === "string" && network in (0, _indexE438853BJs.C)) return (0, _indexE438853BJs.C)[network];
     ...
     */ off(eventName, listener) {
        if ((0, _indexE438853BJs.i)(eventName)) return this._off(eventName, listener);
     ...
     */ removeAllListeners(eventName) {
        if (eventName !== undefined && (0, _indexE438853BJs.i)(eventName)) return this._removeAllListeners(eventName);
     ...
     */ listenerCount(eventName) {
        if (eventName !== undefined && (0, _indexE438853BJs.i)(eventName)) return this._listenerCount(eventName);
     ...
     * @override
     */ listeners(eventName) {
        if (eventName !== undefined && (0, _indexE438853BJs.i)(eventName)) return this._listeners(eventName);
     ...
     */ _addEventListener(eventName, listener, once) {
        if ((0, _indexE438853BJs.i)(eventName)) {
            (0, _indexE438853BJs.v)(eventName);
            const event = new (0, _indexE438853BJs.c)((0, _indexE438853BJs.e)(eventName), listener, once);
     ...
     */ emit(eventName, ...args) {
        if ((0, _indexE438853BJs.i)(eventName)) {
            ...
            const eventTag = (0, _indexE438853BJs.e)(eventName);
     ...
     * @override
     */ isCommunityResource() {
        return this.apiKey === (0, _indexE438853BJs.D);
    }
    /**
     * DO NOT MODIFY.
     *
     ...
     */ _stopEvent(event) {
        let tag = event.tag;
        // START MODIFIED CODE
        if ((0, _indexE438853BJs.A).includes(event.type)) {
            // There are remaining pending transaction listeners.
            if (this._events.filter((e)=>(0, _indexE438853BJs.A).includes(e.type)).length) return;
        // END MODIFIED CODE
     ...
     */ startHeartbeat() {
        ...
        this.heartbeatIntervalId = setInterval(()=>(0, _indexE438853BJs._)(this, void 0, void 0, function*() {
                try {
    ...
    /** @internal */ customStartEvent(event) {
        if (event.type === (0, _indexE438853BJs.h)) {
            const { fromAddress, toAddress, hashesOnly } = event;
            this._subscribe(event.tag, [
                (0, _indexE438853BJs.j).PENDING_TRANSACTIONS,
                {
                    fromAddress,
                    toAddress,
                    hashesOnly
        ...
        } else if (event.type === (0, _indexE438853BJs.k)) {
            const { addresses, includeRemoved, hashesOnly } = event;
            this._subscribe(event.tag, [
                (0, _indexE438853BJs.j).MINED_TRANSACTIONS,
                {
                    addresses,
                    includeRemoved,
                    hashesOnly
    ...
    /** @internal */ emitProcessFn(event) {
        switch(event.type){
            case 0, _indexE438853BJs.h:
                return (result)=>this.emit({
                        method: (0, _indexE438853BJs.j).PENDING_TRANSACTIONS,
                        fromAddress: event.fromAddress,
                        toAddress: event.toAddress,
                        hashesOnly: event.hashesOnly
                    }, result);
            case 0, _indexE438853BJs.k:
                return (result)=>this.emit({
                        method: (0, _indexE438853BJs.j).MINED_TRANSACTIONS,
...
function getWebsocketConstructor() {
    return isNodeEnvironment() ? require("44201a1f0b30f07c").w3cwebsocket : WebSocket;
}
...
function getNewHeadsBlockNumber(event) {
    return (0, _indexE438853BJs.f)(event.number);
}
function getLogsBlockNumber(event) {
    return (0, _indexE438853BJs.f)(event.blockNumber);
}
...
},{"b0b4f65f1c924f4b":"d5jf4","./index-e438853b.js":"8O7ZF","sturdy-websocket":"V1Y2z","@ethersproject/bignumber":"ckYYW","@ethersproject/networks":"6JNhW","@ethersproject/providers":"bErvj","./alchemy-provider-3b044dd5.js":"6I3AY","./api/utils":"byXgH","axios":"6SddO","@ethersproject/abstract-provider":"g1jr1","@ethersproject/wallet":"2DfhD","@ethersproject/contracts":"97okZ","@ethersproject/web":"5yjI3","44201a1f0b30f07c":"aRycB","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"V1Y2z":[function(require,module,exports) {
"use strict";
...
},{}]},["7O2or"], null, "parcelRequire94c2")

//# sourceMappingURL=alchemy-websocket-provider-6cafeb36.1bc6ed56.js.map
