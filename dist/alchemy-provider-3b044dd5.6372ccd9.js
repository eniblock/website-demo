...
})({"7Eow0":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = 50619;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "cbe0952d6372ccd9";
"use strict";
...
},{}],"6I3AY":[function(require,module,exports) {
 ...
 */ class AlchemyProvider extends (0, _providers.JsonRpcProvider) {
     ...
     */ static getApiKey(apiKey) {
        if (apiKey == null) return 0, _indexE438853BJs.D;
     ...
     */ static getAlchemyNetwork(network) {
        if (network === undefined) return 0, _indexE438853BJs.a;
        if (typeof network === "number") throw new Error(`Invalid network '${network}' provided. Network must be a string.`);
        // Guaranteed that `typeof network === 'string`.
        const isValidNetwork = Object.values((0, _indexE438853BJs.N)).includes(network);
        if (!isValidNetwork) throw new Error(`Invalid network '${network}' provided. Network must be one of: ` + `${Object.values((0, _indexE438853BJs.N)).join(", ")}.`);
        return network;
    }
    /**
     ...
     */ static getAlchemyConnectionInfo(network, apiKey, type) {
        const url = type === "http" ? (0, _indexE438853BJs.g)(network, apiKey) : (0, _indexE438853BJs.b)(network, apiKey);
        return {
            headers: (0, _indexE438853BJs.I) ? {
                "Alchemy-Ethers-Sdk-Version": (0, _indexE438853BJs.V)
            } : {
                "Alchemy-Ethers-Sdk-Version": (0, _indexE438853BJs.V),
    ...
    _startPending() {
        (0, _indexE438853BJs.l)("WARNING: Alchemy Provider does not support pending filters");
    }
    /**
     ...
     */ _send(method, params, methodName, forceBatch = false) {
        ...
        this.emit("debug", {
            action: "request",
            request: (0, _indexE438853BJs.d)(request),
            provider: this
        });
...
},{"./index-e438853b.js":"8O7ZF","@ethersproject/networks":"6JNhW","@ethersproject/providers":"bErvj","@ethersproject/web":"5yjI3","./api/utils":"byXgH","@ethersproject/bignumber":"ckYYW","axios":"6SddO","@ethersproject/abstract-provider":"g1jr1","@ethersproject/wallet":"2DfhD","@ethersproject/contracts":"97okZ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["7Eow0"], null, "parcelRequire94c2")

//# sourceMappingURL=alchemy-provider-3b044dd5.6372ccd9.js.map
